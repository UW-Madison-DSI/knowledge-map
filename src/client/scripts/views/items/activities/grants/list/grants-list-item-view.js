...
import ActivitiesItemView from '../../activities-list-item-view.js';
import GrantDetailsView from '../list/grant-details-view.js';

export default ActivitiesItemView.extend({
